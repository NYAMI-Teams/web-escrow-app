...
const RekberInfoSection = ({
    ...
    deadlineDate = null,
    seller = rekberInfo.seller,
    buyer = rekberInfo.buyer,
    virtualAccount = rekberInfo.virtualAccount,
    transactionId = rekberInfo.transactionId,
    productName = rekberInfo.productName,
    bill = rekberInfo.bill,
    pengajuanBadge = null,
    deadlineBadge = null,
    currentStatus = null,
